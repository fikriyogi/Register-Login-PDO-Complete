		...
		<aside id="left-panel">
			...
			<nav id="nav">
				...
				<ul>
					...
					<li <?php if( basename($_SERVER['PHP_SELF'], '.php') == 'datatables' ) { ?> class="active" <?php } else { ?> <?php }?>>
						<a href="datatables.php"><i class="fa fa-lg fa-fw fa-users txt-color-blue"></i> <span class="menu-item-parent">Members</span></a>
					</li>
					<li <?php if( basename($_SERVER['PHP_SELF'], '.php') == 'setting' ) { ?> class="active" <?php } else { ?> <?php }?>>
						<a href="setting"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">Setting</span> <span class="badge pull-right inbox-badge margin-right-13">14</span></a>
					</li>
					<li>
